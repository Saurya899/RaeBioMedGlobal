...
<head>
    ...
    <head>
        ...
        <!-- Primary Meta Tags -->
        <title>RaeBioMedGlobal Healthtech - Leading Medical Equipment Supplier in India</title>
            ...
            <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="3000">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <img src="assets/Images/2banner.jpg" class="d-block w-100 banner-img" alt="Healthcare Products">
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <h1 class="display-5 fw-bold text-white">Trusted Medical Equipment Supplier</h1>
                            <p class="lead">Delivering top-quality healthcare products to hospitals, clinics, and professionals.</p>
                            <a href="#" class="btn btn-outline-light btn-lg rounded-pill px-4 mt-3">Explore Products</a>
                        </div>
                    </div>

                    <!-- Slide 2 -->
                    <div class="carousel-item">
                        <img src="assets/Images/3banner.jpg" class="d-block w-100 banner-img" alt="Medical Supplies">
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <h1 class="display-5 fw-bold text-white">Innovative Solutions for Modern Healthcare</h1>
                            <p class="lead">Providing advanced medical devices and supplies for better patient outcomes.</p>
                            <a href="#" class="btn btn-outline-light btn-lg rounded-pill px-4 mt-3">Shop Now</a>
                        </div>
                    </div>

                    <!-- Slide 3 -->
                    <div class="carousel-item">
                        <img src="assets/Images/banner1.jpg" class="d-block w-100 banner-img" alt="Hospital Equipment">
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <h1 class="display-5 fw-bold text-white">Reliable Equipment. Exceptional Service.</h1>
                            <p class="lead">Supplying trusted medical products with fast delivery and expert support.</p>
                            <a href="#" class="btn btn-outline-light btn-lg rounded-pill px-4 mt-3">Contact Sales</a>
                        </div>
                    </div>
                </div>
